...
Admin đăng nhập bằng username + password qua form thay vì `?secret=` trong URL.

**Lý do ưu tiên**: `?secret=` trong URL lộ thông tin trong browser history và server log. Form login là yêu cầu bảo mật tối thiểu cho khu vực admin.
